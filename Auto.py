...
if hash_password(input_password) == correct_password_hash:
    ...
    print("Buy The Script To Use It ... To buy it : +201016977024")
    sys.exit()
...
cprint("""
┏━━━━━━━━━━━━━━━━━━━━━━━━━━┓           
❖ Code By  : Ahmed M Alqareesh                   ❖
❖ Instagram: @bnmagdii                                    ❖

                         • سيتم استخدام القانون في حال تم سرقة الاسكريبت من طرف آخر •
	...
	while True:
		...
		try:
			...
			for i in range(len(animation)):
			   time.sleep(6)
			   sys.stdout.write("\r[+] @bnmagdii ... " + animation[i % len(animation)])
			   sys.stdout.flush()
		except:
